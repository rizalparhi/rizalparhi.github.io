...
class Barang extends CI_Controller
{
    function __construct()
    {
        ...
        $this->form_validation->set_message(array(
            ...
            'is_unique'   => '%s Sudah Ada / Data Harga Sudah Diinputkan Ke Cabang Tersebut',
    ...
    function index()
    {
        // Memanggil kode barang dari function cetak kodebarang di M_barang 
          $data=array(
    ...
    function update_barang()
    {
        ...
        $this->form_validation->set_rules('namabarang','nama barang','required');
        $this->form_validation->set_rules('harga_modal','harga_modal','required');
    ...
    function harga()
    {
        ...
        $data['barang']=$this->M_barang->getDataBarang();
        // $data['barang']=$this->M_barang->getDataBarangHarga();
    ...
    function formInputHarga()
    {
        $kode_cabang=$this->input->post('kode_cabang');
       
        // $data['barang']=$this->M_barang->getDataBarangHarga()->result();
         $data['barang']=$this->M_barang->getDataBarang();
    ...
    function inputharga()
    {
       ...
       $this->form_validation->set_rules('harga_modal','harga_modal','required');
       $this->form_validation->set_rules('harga_bakul','harga_bakul','required');
