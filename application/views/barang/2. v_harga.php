        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <button type="button" id="tambahharga" class="btn btn-primary btn  mb-3 mr-4" data-toggle="modal"  >
                    ...
                    ?>
                            <tr align="center" ;>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url() ?>barang/tambahStok/<?php echo $hr->kode_harga; ?>"
                                        class="btn btn-primary btn-sm mb-3">
                                        <i class=" fas fa-plus"></i>
                                        Tambah stok
                                    </a>

                                    <a href="<?php echo base_url() ?>barang/editHarga/<?php echo $hr->kode_harga; ?>"
                                        class="btn btn-warning btn-sm mb-3">
                                        <i class=" fas fa-edit"></i>
                                        Edit
                                    </a>

                                    <a href="<?php echo base_url()?>barang/hapusDataHarga/<?php echo $hr->kode_harga;?>"
...
<div class="modal fade" id="modaltambahharga" tabindex="-1" role="dialog" aria-labelledby="modaltambahharga"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
             ...
             <div class="modal-header">
                ...
                <div>
                    ...
                    <ul>
                        <li> Form Daftar Nama Barang Berdasarkan data barang yang telah diinput dari Menu Data Barang </li>
                    </ul>
                </div>
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo base_url()?>barang/inputHarga" class="formbarang" method="POST" id="formtambahharga">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  class="form-control harga" name="harga_modal" id="harga_modal" placeholder=" Harga Modal"  >
                    </div>
                    
                    <div class="mb-3">
                        <label class="form-label">Harga Bakul</label>
                        <input type="text" class="form-control harga" name="harga_bakul" id="harga_bakul" placeholder="Masukan Harga Bakul">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Harga Eceran</label>
                        <input type="text" class="form-control harga" name="harga" id="harga" placeholder="Masukan Jual Barang">
                    </div>
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        <div class="form-group">
                            ...
                            <div class="mb-1">
                             Data Harga ini akan disimpan di Cabang mana,  Jika Barang Di simpan digudang pilih gudang
                            </div>
